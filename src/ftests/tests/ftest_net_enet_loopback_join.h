...
// Join half of a real two-process ENet loopback session -- see
// ftest_net_enet_loopback_shared.h and
// docs/refactor/todo/ftest-fake-multiplayer.md (Phase 2). Only makes sense
// run together with ftest_net_enet_loopback_host_init() as a *separate*
// keeperfx process, via scripts/run_ftest_net_enet_loopback.sh -- run
// standalone, netstate.sp->join() fails outright (nothing listening).
