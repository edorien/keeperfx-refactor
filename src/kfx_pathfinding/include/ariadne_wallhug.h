...
/******************************************************************************/
#define CHECK_SLAB_OWNER (flag_is_set(crt_owner_flags, to_flag(pathfinding_world->slabmap_owner(slb)))) // return TRUE if the slab's owner is stored in crt_owner_flags
