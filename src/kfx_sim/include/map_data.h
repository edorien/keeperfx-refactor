...
/******************************************************************************/
/* STL_PER_SLB, COORD_PER_STL, COORD_PER_SLB, and the subtile/slab/coord
 * conversion macros (subtile_slab, slab_subtile, slab_subtile_center,
 * coord_subtile, coord_slab, subtile_coord, slab_coord,
 * subtile_coord_center) moved to kfx_platform/include/globals.h
 * (stage-06a-ariadne-pathfinding-interface.md physical split) -- pure,
 * zero-state coordinate math needed by both kfx_sim and kfx_pathfinding,
 * reachable from here via the globals.h include above. */
/******************************************************************************/
