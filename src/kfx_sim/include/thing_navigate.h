...
/* SlabBlockedFlags / SlbBloF_* moved to kfx_platform/include/globals.h
 * (stage-06a-ariadne-pathfinding-interface.md physical split) -- shared
 * pure constants, reachable from here via the globals.h include above. */
