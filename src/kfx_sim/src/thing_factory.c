    ...
    case TCls_Object:
        ...
        if (!thing_is_invalid(thing))
        {
            ...
            else if (thing_is_custom_special_box(thing))
            {
                ...
                if (itng->params[1] > kfx_sim_state.max_custom_box_kind)
                {
                    kfx_sim_state.max_custom_box_kind = itng->params[1];
                }
            }
        ...
        case TCls_Object:
            ...
            if (!thing_is_invalid(thing))
            {
                ...
                else if (thing_is_custom_special_box(thing))
                {
                    ...
                    if (box_kind > kfx_sim_state.max_custom_box_kind)
                    {
                        kfx_sim_state.max_custom_box_kind = box_kind;
                    }
                }
