...
// get_party_index_of_name()/create_party()/add_member_to_party()/
// delete_member_from_party() moved to kfx_game's lvl_script.c (stage 13.4,
// docs/refactor/stage-13-enforce-and-document.md) -- they're level-script
// party-definition CRUD, not simulation logic, and every caller is
// kfx_game/kfx_script already.
...
// script_process_new_tunneller_party() moved to kfx_game's lvl_script.c
// (stage 13.4, docs/refactor/stage-13-enforce-and-document.md) -- same
// reason as the party-CRUD functions above (indexes kfx_game_state.script.
// creature_partys directly; every caller is kfx_game/kfx_script already).
