...
// Moved here from front_input.h (stage 10, docs/refactor/stage-10-kfx-frontend.md)
// -- gui_frontbtns.c/gui_tooltips.c need LbBFeF_IntValueMask/LbBFeF_NoTooltip
// without depending on front_input.h (kfx_frontend's higher internal
// sub-layer), same "small vocabulary enum" treatment as stages 6/9's
// MessageTypes/GUI_Menus/IngameButtonGroupIDs moves.
...
/******************************************************************************/
// Exported functions
// Populated once by config_sounds.c's cache_common_sound_ids() after
// config load -- do_sound_menu_click()/do_sound_button_click() use these
// bflib-owned copies instead of reading config_sounds.h's globals
// directly (see docs/refactor/stage-02-decouple-bflib.md).
void set_gui_click_sound_ids(SoundSmplTblID button_click_id, SoundSmplTblID tab_click_id);
