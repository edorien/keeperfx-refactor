...
// Pushes the current frame's delta_time/turns_per_second (struct Game
// state), called once per frame from the game loop, so this file doesn't
// need game_legacy.h directly. See docs/refactor/stage-02-decouple-bflib.md.
