...
// Mirrors player_data.h's COLOURS_COUNT (a stable, tiny constant) instead
// of including that kfx_sim-layer header just for one value -- this file
// previously got it transitively via thing_creature.h's now-removed
// packets.h include (stage 6, docs/refactor/stage-06-kfx-sim.md).
#define CUBE_COLOURS_COUNT 9
/******************************************************************************/
