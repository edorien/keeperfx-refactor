...
struct GuiButtonInit frontend_net_session_buttons[] = {
  ...
  { .gbtype = 5, .id_num = -1, .click_event = frontnet_session_set_player_name, .ptover_event = frontend_over_button, .btype_value = 19, .scr_pos_x = 200, .scr_pos_y = 63, .pos_x = 95, .pos_y = 63, .width = 432, .height = 25, .draw_call = frontend_draw_enter_text, .tooltip_stridx = GUIStr_Empty, .content = { .str = tmp_net_player_name }, .maxval = 20 },
