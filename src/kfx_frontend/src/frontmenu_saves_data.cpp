...
struct GuiButtonInit save_menu_buttons[] = {
  ...
  { .gbtype = 5, .id_num = -2, .button_flags = 3, .click_event = gui_save_game, .scr_pos_x = 999, .scr_pos_y = 58, .pos_x = 999, .pos_y = 58, .width = 300, .height = 32, .draw_call = gui_area_text, .sprite_idx = 1, .tooltip_stridx = GUIStr_Empty, .content = { .str = input_string[0] }, .maxval = SAVE_TEXTNAME_LEN },
  { .gbtype = 5, .id_num = -2, .button_flags = 3, .click_event = gui_save_game, .btype_value = 1, .scr_pos_x = 999, .scr_pos_y = 90, .pos_x = 999, .pos_y = 90, .width = 300, .height = 32, .draw_call = gui_area_text, .sprite_idx = 1, .tooltip_stridx = GUIStr_Empty, .content = { .str = input_string[1] }, .maxval = SAVE_TEXTNAME_LEN },
  { .gbtype = 5, .id_num = -2, .button_flags = 3, .click_event = gui_save_game, .btype_value = 2, .scr_pos_x = 999, .scr_pos_y = 122, .pos_x = 999, .pos_y = 122, .width = 300, .height = 32, .draw_call = gui_area_text, .sprite_idx = 1, .tooltip_stridx = GUIStr_Empty, .content = { .str = input_string[2] }, .maxval = SAVE_TEXTNAME_LEN },
  { .gbtype = 5, .id_num = -2, .button_flags = 3, .click_event = gui_save_game, .btype_value = 3, .scr_pos_x = 999, .scr_pos_y = 154, .pos_x = 999, .pos_y = 154, .width = 300, .height = 32, .draw_call = gui_area_text, .sprite_idx = 1, .tooltip_stridx = GUIStr_Empty, .content = { .str = input_string[3] }, .maxval = SAVE_TEXTNAME_LEN },
  { .gbtype = 5, .id_num = -2, .button_flags = 3, .click_event = gui_save_game, .btype_value = 4, .scr_pos_x = 999, .scr_pos_y = 186, .pos_x = 999, .pos_y = 186, .width = 300, .height = 32, .draw_call = gui_area_text, .sprite_idx = 1, .tooltip_stridx = GUIStr_Empty, .content = { .str = input_string[4] }, .maxval = SAVE_TEXTNAME_LEN },
  { .gbtype = 5, .id_num = -2, .button_flags = 3, .click_event = gui_save_game, .btype_value = 5, .scr_pos_x = 999, .scr_pos_y = 218, .pos_x = 999, .pos_y = 218, .width = 300, .height = 32, .draw_call = gui_area_text, .sprite_idx = 1, .tooltip_stridx = GUIStr_Empty, .content = { .str = input_string[5] }, .maxval = SAVE_TEXTNAME_LEN },
  { .gbtype = 5, .id_num = -2, .button_flags = 3, .click_event = gui_save_game, .btype_value = 6, .scr_pos_x = 999, .scr_pos_y = 250, .pos_x = 999, .pos_y = 250, .width = 300, .height = 32, .draw_call = gui_area_text, .sprite_idx = 1, .tooltip_stridx = GUIStr_Empty, .content = { .str = input_string[6] }, .maxval = SAVE_TEXTNAME_LEN },
  { .gbtype = 5, .id_num = -2, .button_flags = 3, .click_event = gui_save_game, .btype_value = 7, .scr_pos_x = 999, .scr_pos_y = 282, .pos_x = 999, .pos_y = 282, .width = 300, .height = 32, .draw_call = gui_area_text, .sprite_idx = 1, .tooltip_stridx = GUIStr_Empty, .content = { .str = input_string[7] }, .maxval = SAVE_TEXTNAME_LEN },
  { .gbtype = LbBtnT_HoldableBtn, .click_event = gui_vscroll_input, .scr_pos_x = 368, .scr_pos_y = 58, .pos_x = 368, .pos_y = 58, .width = 33, .height = 254, .draw_call = gui_vscroll_draw, .tooltip_stridx = GUIStr_Empty, .maintain_call = gui_vscroll_maintain },
  { .gbtype = -1 },
};
